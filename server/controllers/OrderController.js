...
export const createOrder = async (req, res) => {
  ...
  try {
    ...
    const orderRes = await client.query(
      `INSERT INTO orders (order_id, customer_id, address_id, subtotal, shipping_charges, tax_amount, total_amount, discount_amount, order_status, payment_status)
       VALUES (gen_random_uuid(), $1, $2, $3, $4, $5, $6, $7, 'Pending', $8)
       RETURNING order_id`,
      [customer_id, address_id, subtotal, shipping_charges, tax_amount, total_amount, discount_amount, payment_status]
    );
