      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {limitedProducts.map((product) => (
          <div
            ...
            className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition cursor-pointer"
          >
            ...
            <div className="relative aspect-square overflow-hidden bg-white p-6 flex items-center justify-center">
              ...
              <div
                ...
                ${hoveredProduct === product.id ? "opacity-100" : "opacity-0 md:group-hover:opacity-100 opacity-100"}
                `}
              >
